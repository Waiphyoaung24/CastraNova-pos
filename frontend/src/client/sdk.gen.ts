...
export class ProductsService {
     ...
     * @throws ApiError
     */
    public static readSkus(): CancelablePromise<ProductsReadSkusResponse> {
        return __request(OpenAPI, {
            method: 'GET',
