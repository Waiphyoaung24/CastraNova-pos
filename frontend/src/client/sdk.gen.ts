...
export class ProductsService {
     ...
     * @throws ApiError
     */
    public static readOptions(): CancelablePromise<ProductsReadOptionsResponse> {
        return __request(OpenAPI, {
            method: 'GET',
